...
static const uint8_t CN_SPLASH2[]  = {0xB5,0xE7,0xD7,0xE8,0xB5,0xE7,0xC8,0xDD,0xB6,0xFE,0xBC,0xAB,0xB9,0xDC,0xC8,0xFD,0xBC,0xAB,0xB9,0xDC,0x4C,0x45,0x44,0x00}; /* 电阻电容二极管LED */
static const uint8_t CN_SPLASH3[]  = {0xC1,0xAC,0xBD,0xD3,0xC6,0xF7,0xBE,0xA7,0xD5,0xF1,0xB5,0xE7,0xB8,0xD0,0x00}; /* 电位器连接器晶振芯片 */
...
void tft_ui_stt_result(const char *text, const char *mode){
    ...
    if(mode&&mode[0]){
        ...
        else if(strstr(mode,"Transistor")) cn_mode=CN_TRANSISTOR;
        ...
        else if(strstr(mode,"Inductor")) cn_mode=CN_INDUCTOR;
