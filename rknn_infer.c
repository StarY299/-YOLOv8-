 ...
 */
static const float CONF_THRESH_PER_CLASS[16] = {
    0.50f,  /* 0: Capacitor */
    0.30f,  /* 1: Diode */
    0.30f,  /* 2: Transistor */
    0.30f,  /* 3: Resister */
                    ...
                    rknn_result_t *result)
{
    ...
    int n_cand = 0;
    int num_classes = 16;  /* 自动适配模型输出: boxes(4) + cls(11) = 15 */
...
out_loop: ;
    ...
    for (int i = 0; i < n_keep; i++) {
        ...
        static const char *names[] = {
            ...
            "Diode-dam","Pot","Connecter","Xtal","IC","Inductor"
        };
